...
$sessions = mysqli_query($conn, "SELECT * FROM sessions WHERE status='active' ORDER BY id DESC");
$total_sessions = mysqli_num_rows($sessions);

// Completed sessions count
$completed_result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM sessions WHERE status='completed'");
$completed_sessions = mysqli_fetch_assoc($completed_result)['total'];

// Handle soft delete (mark as completed)
if (isset($_GET['complete_id'])) {
    $id = intval($_GET['complete_id']);
    mysqli_query($conn, "UPDATE sessions SET status='completed' WHERE id=$id");
...
<head>
    <meta charset="UTF-8">
    <title>Sessions Management | Academy Management System</title>
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-4">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Sessions Management</h1>
            ...
            <div class="grid grid-cols-2 gap-3 mb-6">
                <div class="bg-white p-3 rounded border text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-800"><?php echo $total_sessions; ?></h3>
                </div>
                <div class="bg-white p-3 rounded border text-center">
                    <p class="text-xs text-gray-500 mb-1">Completed Sessions</p>
                    <h3 class="text-xl font-bold text-gray-800"><?php echo $completed_sessions; ?></h3>
                </div>
            </div>
            ...
            <div class="table-container">
                <div class="px-4 py-3 border-b bg-gray-50">
                    <h3 class="font-medium text-gray-800">Active Sessions (<?php echo $total_sessions; ?>)</h3>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3 px-4">
                                            <div class="flex gap-1">
                                                ...
                                                <a href="sessions.php?complete_id=<?= $row['id'] ?>"
                ...
                <?php else: ?>
                    <div class="p-8 text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-700 mb-2">No Active Sessions</h3>
                        <p class="text-gray-500 text-sm mb-4">Create your first training session</p>
                        <a href="add_session.php"
