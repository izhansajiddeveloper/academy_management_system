...
$total_completed = mysqli_num_rows($batches);

// Optionally allow marking completed batch back to active
if (isset($_GET['activate_id'])) {
    $id = intval($_GET['activate_id']);
    mysqli_query($conn, "UPDATE batches SET status='active' WHERE id=$id");
    header("Location: completed_batches.php");
    exit;
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Completed Batches | Academy Management System</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="httpscdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <style>
        * {
    ...
    <div class="flex">
        ...
        <aside class="w-64 sidebar h-screen sticky top-0">
            ...
            <nav class="p-3 space-y-1">
                ...
                <div class="mt-4">
                    ...
                    <a href="batches.php" class="sidebar-link">
                        <i class="fas fa-layer-group"></i> Batches
                    </a>
                    <a href="completed_batches.php" class="sidebar-link active">
            ...
            <div class="p-3 border-t border-gray-700 mt-auto">
                <a href="batches.php" class="w-full flex items-center justify-center gap-2 text-sm p-2 rounded bg-blue-600 text-white hover:bg-blue-700">
        ...
        <main class="flex-1 p-4">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Completed Batches</h1>
                    <p class="text-gray-500 text-sm mt-1">
                        <i class="fas fa-history text-gray-500 mr-1"></i>
                        View and manage completed batches
                    </p>
                </div>
                <div class="flex items-center gap-3">
                    ...
                    <a href="batches.php"
                        ...
                        <i class="fas fa-arrow-left mr-1"></i> Active Batches
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3 mb-6">
                <div class="bg-white p-3 rounded border text-center">
                    <p class="text-xs text-gray-500 mb-1">Completed Batches</p>
                    <h3 class="text-xl font-bold text-gray-800"><?php echo $total_completed; ?></h3>
                </div>
                <div class="bg-white p-3 rounded border text-center">
                    <p class="text-xs text-gray-500 mb-1">Actions</p>
                    <div class="mt-2">
                        <a href="batches.php" class="text-sm text-blue-600 hover:text-blue-800">
            ...
            <div class="table-container">
                <div class="px-4 py-3 border-b bg-gray-50">
                    <h3 class="font-medium text-gray-800">Completed Batches (<?php echo $total_completed; ?>)</h3>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3 px-4">
                                            <div class="flex gap-1">
                                                <a href="completed_batches.php?activate_id=<?= $row['id'] ?>"
                ...
                <?php else: ?>
                    <div class="p-8 text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-700 mb-2">No Completed Batches</h3>
                        <p class="text-gray-500 text-sm mb-4">No batches have been marked as completed yet</p>
                        <a href="batches.php"
                            class="inline-flex items-center gap-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm">
                            <i class="fas fa-arrow-left"></i> View Active Batches
                        </a>
                    </div>
                <?php endif; ?>
            </div>
