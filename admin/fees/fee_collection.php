        ...
        <aside class="w-64 sidebar h-screen sticky top-0">
            ...
            <nav class="p-3 space-y-1">
                ...
                <div class="mt-4">
                    ...
                    <a href="fee_collection.php" class="sidebar-link active">
            ...
            <div class="p-3 border-t border-gray-700 mt-auto">
                <a href="collect_fee.php" class="w-full flex items-center justify-center gap-2 text-sm p-2 rounded bg-green-600 text-white hover:bg-green-700">
