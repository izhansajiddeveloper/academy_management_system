...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_attendance'])) {
    ...
    $update_query = "UPDATE student_attendance SET attendance_status = '$attendance_status', remarks = '$remarks', updated_at = NOW() WHERE id = $attendance_id";
    mysqli_query($conn, $update_query);

    header("Location: edit_student_attendance.php?success=1&id=" . $attendance_id);
    exit;
}
...
if (isset($_GET['delete_id'])) {
    ...
    $delete_query = "UPDATE student_attendance SET status='inactive' WHERE id = $delete_id";
    mysqli_query($conn, $delete_query);

    header("Location: edit_student_attendance.php?deleted=1");
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>Edit Student Attendance | Academy Management System</title>
...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="flex">
        ...
        <aside class="w-64 sidebar h-screen sticky top-0">
            ...
            <nav class="p-3 space-y-1">
                ...
                <div class="mt-4">
                    ...
                    <a href="take_student_attendance.php" class="sidebar-link">
                        <i class="fas fa-plus"></i> Take Student Attendance
                    </a>
                    <a href="edit_student_attendance.php" class="sidebar-link active">
        ...
        <main class="flex-1 p-4">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Edit Student Attendance</h1>
                    <p class="text-gray-500 text-sm mt-1">
                        <i class="fas fa-edit text-blue-500 mr-1"></i>
                        Modify and update student attendance records
                    </p>
                </div>
            </div>
            ...
            <div class="form-container mb-6">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="batch_id" class="search-box">
                    ...
                    <div>
                        ...
                        <select name="attendance_status" class="search-box">
                    ...
                    <div class="md:col-span-4 flex justify-end gap-2">
                        <a href="edit_student_attendance.php" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded text-sm font-medium">
                            Clear Filters
                        </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3 px-4">
                                            <div class="flex gap-2">
                                                <button onclick="openEditModal(<?= $record['id'] ?>, '<?= $record['student_name'] ?>', '<?= $record['attendance_status'] ?>', '<?= htmlspecialchars($record['remarks']) ?>')"
                                                    class="text-blue-600 hover:text-blue-800 text-sm">
                                                    <i class="fas fa-edit"></i> Edit
                                                </button>
                                                <a href="edit_student_attendance.php?delete_id=<?= $record['id'] ?>"
    ...
    <div id="editModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-4">Edit Attendance</h3>
                <form id="editForm" method="POST">
                    <input type="hidden" name="attendance_id" id="modalAttendanceId">

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Student</label>
                        <input type="text" id="modalStudentName" class="search-box w-full" disabled>
                    </div>
    ...
    <script>
        function openEditModal(id, studentName, status, remarks) {
