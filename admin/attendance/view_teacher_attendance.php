...
<head>
    <meta charset="UTF-8">
    <title>View Teacher Attendance | Academy Management System</title>
    ...
    <div class="flex">
        ...
        <aside class="w-64 sidebar h-screen sticky top-0">
            ...
            <nav class="p-3 space-y-1">
                ...
                <div class="mt-4">
                    ...
                    <a href="view_teacher_attendance.php" class="sidebar-link active">
        ...
        <main class="flex-1 p-4">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">View Teacher Attendance</h1>
                    <p class="text-gray-500 text-sm mt-1">
                        <i class="fas fa-eye text-blue-500 mr-1"></i>
                        View and analyze teacher attendance records
                    </p>
                </div>
            ...
            <div class="form-container mb-6">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-3 flex justify-end gap-2">
                        <a href="view_teacher_attendance.php" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded text-sm font-medium">
                            Clear Filters
                        </a>
